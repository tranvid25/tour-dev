...
<section class="hidden-bar">
            <div class="inner-box text-center">
                ...
                <div class="appointment-form">
                    ...
                    <ul class="dropdown-menu" id="dropdownMenu">
                        ...
                        <li>
                            <a href="{{ session('user') ? route('clients.user.edit', ['id' => session('user')['id']]) : '#' }}" class="btn btn-primary">
                               Thông tin cá nhân
                            </a>
                        </li>
        ...
        <section class="hero-area bgc-black pt-200 rpt-120 rel z-2">
            <div class="container-fluid">
                ...
                <div class="main-hero-image bgs-cover" style="background-image: url(clients/assets/images/hero/hero.jpg);"></div>
            </div>
            <div class="container  container-1400" style="padding-left: 0px;padding-right:0px;">
                <div class="search-filter-inner" data-aos="zoom-out-down" data-aos-duration="1500" data-aos-offset="50">
                    ...
                    <div class="filter-item clearfix">
                        ...
                        <input type="date" id="start_date" name="start_date" class="datetimepicker datetimepicker-custom" placeholder="Chọn ngày đi">
                    </div>
                    <div class="filter-item clearfix">
                        <div class="icon"><i class="fal fa-calendar-alt"></i></div>
                        <span class="title">End Date</span>
                        <input type="date" id="end_date" name="end_date" class="datetimepicker datetimepicker-custom" placeholder="Chọn ngày kết thúc">
                    </div>
                    <div class="filter-item clearfix">
                    ...
                    <div class="col-xxl-3 col-xl-4 col-md-6">
                        <div class="destination-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                            <div class="image">
                                ...
                                <img src="/clients/assets/images/destinations/visiting-place1.jpg" alt="Destination">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-xxl-3 col-xl-4 col-md-6">
                        <div class="destination-item" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1500" data-aos-offset="50">
                            <div class="image">
                                <div class="ratting"><i class="fas fa-star"></i> 4.8</div>
                                <a href="#" class="heart"><i class="fas fa-heart"></i></a>
                                <img src="/clients/assets/images/destinations/visiting-place2.jpg" alt="Destination">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-xxl-3 col-xl-4 col-md-6">
                        <div class="destination-item" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1500" data-aos-offset="50">
                            <div class="image">
                                <div class="ratting"><i class="fas fa-star"></i> 4.8</div>
                                <a href="#" class="heart"><i class="fas fa-heart"></i></a>
                                <img src="/clients/assets/images/destinations/visiting-place3.jpg" alt="Destination">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-xxl-3 col-xl-4 col-md-6">
                        <div class="destination-item" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1500" data-aos-offset="50">
                            <div class="image">
                                <div class="ratting"><i class="fas fa-star"></i> 4.8</div>
                                <a href="#" class="heart"><i class="fas fa-heart"></i></a>
                                <img src="/clients/assets/images/destinations/visiting-place4.jpg" alt="Destination">
                            </div>
                            <div class="content">
                                <span class="location"><i class="fal fa-map-marker-alt"></i> Rome, Italy</span>
                                <h5><a href="destination-details.html">Woman standing near Colosseum, Rome</a></h5>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-7 col-lg-6" data-aos="fade-right" data-aos-duration="1500" data-aos-offset="50">
                        <div class="about-us-image">
                            <div class="shape"><img src="/clients/assets/images/about/shape1.png" alt="Shape"></div>
                            <div class="shape"><img src="/clients/assets/images/about/shape2.png" alt="Shape"></div>
                            <div class="shape"><img src="/clients/assets/images/about/shape3.png" alt="Shape"></div>
                            <div class="shape"><img src="/clients/assets/images/about/shape4.png" alt="Shape"></div>
                            <div class="shape"><img src="/clients/assets/images/about/shape5.png" alt="Shape"></div>
                            <div class="shape"><img src="/clients/assets/images/about/shape6.png" alt="Shape"></div>
                            <div class="shape"><img src="/clients/assets/images/about/shape7.png" alt="Shape"></div>
                    ...
                    <div class="col-lg-5">
                        <div class="mobile-app-content rmb-55" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">
                            ...
                            <div class="google-play-app-store">
                                <a href="#"><img src="/clients/assets/images/mobile-app/g-play.jpg" alt="Google Play"></a>
                                <a href="#"><img src="/clients/assets/images/mobile-app/a-store.jpg" alt="App Store"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="mobile-app-images">
                            <div class="bg"><img src="/clients/assets/images/mobile-app/phone-bg.png" alt="BG"></div>
                            <div class="images">
                                <img src="/clients/assets/images/mobile-app/phone2.png" alt="Phone" data-aos="fade-down-left" data-aos-duration="1500" data-aos-offset="50">
                                <img src="/clients/assets/images/mobile-app/phone.png" alt="Phone">
                                <img src="/clients/assets/images/mobile-app/phone3.png" alt="Phone" data-aos="fade-up-right" data-aos-duration="1500" data-aos-offset="50">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="testimonials-wrap bgc-lighter">
                    <div class="row">
                        <div class="col-lg-5 rel" data-aos="fade-right" data-aos-duration="1500" data-aos-offset="50">
                            <div class="testimonial-left-image rmb-55" style="background-image: url(clients/assets/images/testimonials/testimonial-left.jpg);"></div>
                        </div>
                        <div class="col-lg-7">
                            <div class="testimonial-right-content" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">
                                ...
                                <div class="testimonials-active">
                                    <div class="testimonial-item">
                                        ...
                                        <div class="author">
                                            <div class="image"><img src="/clients/assets/images/testimonials/author.jpg" alt="Author"></div>
                                            <div class="content">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-4 col-md-6" data-aos="zoom-in-down" data-aos-duration="1500" data-aos-offset="50">
                        <div class="cta-item" style="background-image: url(clients/assets/images/cta/cta1.jpg);">
                    ...
                    <div class="col-xl-4 col-md-6" data-aos="zoom-in-down" data-aos-delay="50" data-aos-duration="1500" data-aos-offset="50">
                        <div class="cta-item" style="background-image: url(clients/assets/images/cta/cta2.jpg);">
                    ...
                    <div class="col-xl-4 col-md-6" data-aos="zoom-in-down" data-aos-delay="100" data-aos-duration="1500" data-aos-offset="50">
                        <div class="cta-item" style="background-image: url(clients/assets/images/cta/cta3.jpg);">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-4 col-md-6">
                        <div class="blog-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                            ...
                            <div class="image">
                                <img src="/clients/assets/images/blog/blog1.jpg" alt="Blog">
                            </div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="blog-item" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1500" data-aos-offset="50">
                            ...
                            <div class="image">
                                <img src="/clients/assets/images/blog/blog2.jpg" alt="Blog">
                            </div>
                            <a href="blog-details.html" class="theme-btn">
                                <span data-hover="Book Now">Read More</span>
                                <i class="fal fa-arrow-right"></i>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="blog-item" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1500" data-aos-offset="50">
                            ...
                            <div class="image">
                                <img src="/clients/assets/images/blog/blog3.jpg" alt="Blog">
                            </div>
                            <a href="blog-details.html" class="theme-btn">
                                <span data-hover="Book Now">Read More</span>
                                <i class="fal fa-arrow-right"></i>
...
@include('clients.layout.footer-home')
