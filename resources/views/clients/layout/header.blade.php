                ...
                <div class="container-fluid clearfix">
                    ...
                    <div class="header-inner rel d-flex align-items-center">
                        <div class="logo-outer">
                            <div class="logo"><a href="index.html"><img src="/clients/assets/images/logos/logo.png" alt="Logo" title="Logo"></a></div>
                        </div>
                        ...
                        <div class="menu-btns py-10">
                            ...
                            <!-- menu sidbar -->
                            <div class="menu-sidebar" style="display: inline-block">
                                <a class=" dropdown-toggle bg-transparent" id="userDropdown">
                                    <i class='bx bxs-user bx-flip-horizontal bx-tada' style="color: #fcfbfb;padding-left:3px;padding-top: 10px;font-size:20px;"></i>
                                </a>
                                <span class="name_user" style="color:antiquewhite;">
