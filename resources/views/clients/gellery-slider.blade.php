...
<section class="gallery-slider-area py-100 rel z-1">
    ...
    <div class="gallery-slider-active">
        <div class="gallery-three-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
            <div class="image">
                <img src="/clients/assets/images/gallery/gallery-slider1.jpg" alt="Gallery">
            </div>
            <div class="content">
        ...
        <div class="gallery-three-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
            <div class="image">
                <img src="/clients/assets/images/gallery/gallery-slider2.jpg" alt="Gallery">
            </div>
            <div class="content">
                <span class="category">Tour & Travel</span>
                <h5><a href="destination-details.html">Brown Concrete Building</a></h5>
        ...
        <div class="gallery-three-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
            <div class="image">
                <img src="/clients/assets/images/gallery/gallery-slider3.jpg" alt="Gallery">
            </div>
            <div class="content">
                <span class="category">Tour & Travel</span>
                <h5><a href="destination-details.html">Brown Concrete Building</a></h5>
        ...
        <div class="gallery-three-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
            <div class="image">
                <img src="/clients/assets/images/gallery/gallery-slider4.jpg" alt="Gallery">
            </div>
            <div class="content">
                <span class="category">Tour & Travel</span>
                <h5><a href="destination-details.html">Brown Concrete Building</a></h5>
        ...
        <div class="gallery-three-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
            <div class="image">
                <img src="/clients/assets/images/gallery/gallery-slider5.jpg" alt="Gallery">
            </div>
            <div class="content">
                <span class="category">Tour & Travel</span>
                <h5><a href="destination-details.html">Brown Concrete Building</a></h5>
